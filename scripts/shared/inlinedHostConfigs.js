...
module.exports = [
  ...
  },
  {
    ...
    paths: [
      ...
      'react-server-dom-bun/client.node.unbundled',
      'react-server-dom-bun/server',
      'react-server-dom-bun/server.browser',
      'react-server-dom-bun/server.node',
      'react-server-dom-bun/server.node.unbundled',
      'react-server-dom-bun/static',
      'react-server-dom-bun/static.browser',
      'react-server-dom-bun/static.node',
      'react-server-dom-bun/static.node.unbundled',
      'react-server-dom-bun/src/client/ReactFlightDOMClientBrowser.js',
      'react-server-dom-bun/src/client/ReactFlightDOMClientNode.js',
      ...
      'react-server-dom-bun/src/server/react-flight-dom-server.node',
      'react-server-dom-bun/src/server/react-flight-dom-server.node.unbundled',
      'react-server-dom-bun/src/server/ReactFlightDOMServerBrowser.js',
      'react-server-dom-bun/src/server/ReactFlightDOMServerNode.js',
      'react-server-dom-bun/src/server/ReactFlightServerConfigBundlerBun.js',
      'react-dom-bindings/src/server/ReactFlightServerConfigDOM.js',
      'react-dom-bindings/src/shared/ReactFlightClientConfigDOM.js',
      'shared/ReactDOMSharedInternals',
      'react-server/src/ReactFlightServerConfigDebugNoop.js',
